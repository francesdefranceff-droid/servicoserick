...
export function clonedRoutes(user) {
  return [
    ...
    <Route key="cloned-procurar-servicos" path="/procurar-servicos" element={!user ? <AuthPage /> : <Navigate to="/services" />} />,
    <Route key="cloned-procurar-ajuda" path="/procurar-ajuda" element={!user ? <AuthPage /> : <Navigate to="/home" />} />,
    <Route key="cloned-oferecer-ajuda" path="/oferecer-ajuda" element={!user ? <AuthPage /> : <Navigate to="/volunteers" />} />,
    ...
    <Route key="cloned-admin" path="/admin" element={user?.role === 'admin' && user?.email === 'admin@pertodemim.app' ? <AdminDashboard /> : <Navigate to="/home" />} />,
    <Route key="cloned-servicos-admin" path="/servicos/admin" element={user?.role === 'admin' && user?.email === 'admin@pertodemim.app' ? <AdminDashboard /> : <Navigate to="/home" />} />,
    ...
    <Route key="cloned-oferecer" path="/oferecer-servicos" element={!user ? <AuthPage /> : <SubscriptionPage />} />,
